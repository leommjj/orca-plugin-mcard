...
function renderNoteHtml(content, resolveImageUrl, options = {}) {
  ...
  html = html.replace(/\[MEMO:([^\]]+)\]/g, '<span class="mcard-memo-ref" data-memo-id="$1">@</span>');
...
function McardPanel({ pluginName: pluginName2, settings, onSettingsChange }) {
  ...
  React.useEffect(() => {
    const handler = (e) => {
      if (e.key === "Escape" && detailNote) setDetailNote(null);
    };
  ...
  function _renderMentionPicker(picker, searchText2, input, onInsert) {
    ...
    if (kw) {
      matched = matched.filter((n) => (n.content || "").toLowerCase().includes(kw));
    }
    ...
    if (matched.length === 0) {
      ...
      listEl.innerHTML = matched.map((n) => {
        ...
        const highlighted = kw ? preview.replace(new RegExp(`(${kw.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")})`, "gi"), '<mark class="mcard-mention-highlight">$1</mark>') : preview;
        return `<div class="mcard-mention-picker-item" data-id="${n.id}">
          <div class="mcard-mention-picker-date">${dateStr}</div>
          <div class="mcard-mention-picker-preview">${highlighted}</div>
        </div>`;
      }).join("");
    }
    picker.innerHTML = "";
  ...
  function renderNoteContent(note) {
    const html = renderNoteHtml(note.content, resolveAssetUrl);
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-shell", children: [
        ...
        tab !== "stats" && tab !== "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mcard-info-sidebar${sidebarCollapsed ? " collapsed" : ""}`, children: [
          ...
          tab === "shuoshuo" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            allTags.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--b3-theme-on-surface-light)", padding: "0 4px" }, children: "暂无标签" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-tag-list", children: allTags.map((tag) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-input-area", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mcard-input-box ${captureText ? "focused" : ""}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-edit-relation-row", children: [
                captureParentIds.length > 0 && captureParentIds.map((pid) => {
                  ...
                  const dateStr = formatDate(parentNote.createdAt).split(" ")[0];
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-edit-relation mcard-edit-relation-parent", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mcard-edit-relation-info", children: [
                      dateStr,
                      ": ",
                      preview
                    ] }),
                  ...
                  "div",
                  {
                    ...
                    children: editingNoteId === note.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-input-box focused mcard-inline-edit", onClick: (e) => e.stopPropagation(), children: [
                      ...
                      (() => {
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-edit-relation-list", children: childNotes.map((childNote) => {
                          const preview = getNotePreview(childNote);
                          const dateStr = formatDate(childNote.createdAt).split(" ")[0];
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        ...
                        note.parent_ids && note.parent_ids.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-relation", onClick: (e) => e.stopPropagation(), children: note.parent_ids.map((pid) => {
                          const parentNote = notes.find((n) => n.id === pid);
                          if (!parentNote) return null;
                          const preview = getNotePreview(parentNote);
                          const dateStr = formatDate(parentNote.createdAt).split(" ")[0];
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mcard-note-relation-info", children: [
                                  dateStr,
                                  ": ",
                                  preview
                                ] })
                        ...
                        memoNotes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-relation", onClick: (e) => e.stopPropagation(), children: memoNotes.map((memoNote) => {
                          const preview = getNotePreview(memoNote);
                          const dateStr = formatDate(memoNote.createdAt).split(" ")[0];
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              className: "mcard-note-relation-item",
        ...
        detailNote && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-overlay", onClick: () => setDetailNote(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-detail-panel", onClick: (e) => e.stopPropagation(), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-detail-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-content", children: renderNoteContent(detailNote) }),
            detailNote.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-tags", children: detailNote.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mcard-detail-tag", children: [
              "#",
              tag
            ] }, tag)) }),
            detailNote.parent_ids && detailNote.parent_ids.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-relation", onClick: (e) => e.stopPropagation(), children: detailNote.parent_ids.map((pid) => {
              const parentNote = notes.find((n) => n.id === pid);
              if (!parentNote) return null;
              const preview = getNotePreview(parentNote);
              const dateStr = formatDate(parentNote.createdAt).split(" ")[0];
            ...
            (() => {
              const memoNotes = notes.filter((n) => n.parent_ids && n.parent_ids.includes(detailNote.id));
              const isAdding = memoInputNoteId === detailNote.id;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-memo-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    className: "mcard-note-memo-btn",
                    onClick: () => {
                      if (isAdding) {
                        setMemoInputNoteId(null);
                        setMemoInputText("");
                      } else {
                        setMemoInputNoteId(detailNote.id);
                        setMemoInputText("");
                        setTimeout(() => {
                          const el = document.querySelector(`[data-detail-memo-input="${detailNote.id}"]`);
                          el == null ? void 0 : el.focus();
                        }, 50);
                      }
                    },
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", width: "14", height: "14", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: memoNotes.length > 0 ? `${memoNotes.length} 条批注` : "批注" })
                    ]
                  }
                ) }),
                memoNotes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-memos", children: memoNotes.map((memoNote) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-note-memo-item", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-memo-content", children: (() => {
                    const memoContent = renderNoteHtml(memoNote.content, resolveAssetUrl, { hideTags: true });
                    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: memoContent } });
                  })() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-note-memo-actions", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-note-memo-date", children: formatAgo(memoNote.createdAt) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        className: "mcard-note-memo-menu-btn",
                        onClick: (e) => {
                          e.stopPropagation();
                          showNoteMenu(memoNote, e.currentTarget);
                        },
                        title: "更多操作",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: "14", height: "14", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" }) })
                      }
                    )
                  ] })
                ] }, memoNote.id)) }),
                isAdding && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-input-box focused", style: { marginTop: "6px" }, onClick: (e) => e.stopPropagation(), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-input-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                    {
                      "data-detail-memo-input": detailNote.id,
                      className: "mcard-input-field",
                      value: memoInputText,
                      onChange: (e) => setMemoInputText(e.target.value),
                      onInput: handleMemoInputDetectMention,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-input-toolbar", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-toolbar-left", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-toolbar-icon", onClick: (e) => {
                        showMemoTagPicker(detailNote.id, e.currentTarget);
                      }, title: "标签", children: "#" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-toolbar-icon", onClick: () => pickImage((md) => {
                        const ta = document.querySelector(`[data-detail-memo-input="${detailNote.id}"]`);
                        if (!ta) return;
                        const start = ta.selectionStart;
                        const end = ta.selectionEnd;
                        const val = ta.value;
                        ...
                        ta.focus();
                        setMemoInputText(ta.value);
                      }), title: "图片", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z" }) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-toolbar-icon", onClick: () => {
                        const ta = document.querySelector(`[data-detail-memo-input="${detailNote.id}"]`);
                        if (!ta) return;
                        const start = ta.selectionStart;
                        ...
                        ta.focus();
                        setMemoInputText(ta.value);
                      }, title: "任务列表", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 5h2v2H3zm4 0h14v2H7zm-4 6h2v2H3zm4 0h14v2H7zm-4 6h2v2H3zm4 0h14v2H7z" }) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-toolbar-icon", onClick: () => {
                        const ta = document.querySelector(`[data-detail-memo-input="${detailNote.id}"]`);
                        if (!ta) return;
                        const start = ta.selectionStart;
                        ...
                        ta.focus();
                        setMemoInputText(ta.value);
                      }, title: "无序列表", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" }) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-toolbar-icon", onClick: () => {
                        const ta = document.querySelector(`[data-detail-memo-input="${detailNote.id}"]`);
                        if (!ta) return;
                        const lines = ta.value.substring(0, ta.selectionStart).split("\n");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-detail-footer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
function WeekView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-notes-list", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 4px", marginBottom: 12, fontSize: 13, color: "var(--b3-theme-on-surface-light)" }, children: [
      "本周共 ",
      notes.length,
      " 条笔记"
    ] }),
...
function RandomView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-notes-list", style: { paddingTop: 20 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-review-card", children: [
    ...
    note ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--b3-theme-on-surface-light)", marginTop: 10 }, children: formatAgo(note.createdAt) }),
      note.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-tags", style: { marginTop: 10 }, children: note.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mcard-note-tag", children: [
        "#",
        tag
      ] }, tag)) }),
...
function McardPanelRenderer() {
  ...
  const onSettingsChange = (patch) => {
    ...
    setSettings(merged);
    try {
      orca.plugins.setSettings(pluginName, merged);
    } catch {
    }
  };
...
async function load(_name) {
  ...
  if (orca.state.headbarButtons["mcard.button"] == null) {
    orca.headbar.registerHeadbarButton("mcard.button", () => /* @__PURE__ */ jsxRuntimeExports.jsx(
      HoverContextMenu,
      {
        menu: (closeMenu) => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          MenuText,
          {
            title: t("Open Mcard panel"),
            onClick: () => {
              closeMenu();
              orca.commands.invokeCommand("mcard.open");
            }
          }
        ) }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
