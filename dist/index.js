...
function renderNoteHtml(content, resolveImageUrl, options = {}) {
  ...
  html = html.replace(/\[MEMO:([^\]]+)\]/g, (_match, id) => {
    var _a;
    const note = (_a = options.notes) == null ? void 0 : _a.find((n) => n.id === id);
    const label = (note == null ? void 0 : note.title) || "@";
    return `<span class="mcard-memo-ref" data-memo-id="${id}">[[${label}]]</span>`;
  });
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-shell", children: [
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-edit-parent-picker", children: filtered.map((n) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: preview })
                        },
                        n.id
                      );
                    }) });
                            ...
                            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-edit-parent-picker", children: filtered.map((n) => {
                              ...
                              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-edit-relation-info", children: preview })
                                },
                                n.id
                              );
                            }) });
        ...
        detailNote && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-overlay", onClick: () => setDetailNote(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-detail-panel", onClick: (e) => e.stopPropagation(), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-detail-body", children: [
            ...
            detailNote.parent_ids && detailNote.parent_ids.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-note-relation", onClick: (e) => e.stopPropagation(), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mcard-parent-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "6", r: "3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "18", cy: "12", r: "3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "18", r: "3" }),
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                memoNotes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-detail-memos", children: memoNotes.map((memoNote) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mcard-note-memo-item", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mcard-note-memo-content", children: (() => {
                    const memoContent = renderNoteHtml(memoNote.content, resolveAssetUrl, { hideTags: true, notes });
